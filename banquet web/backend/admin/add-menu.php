    ...
    <section class="pakage mt-3" id="#content-page">
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="add-menu-insert-query.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <input name="headprice" type="number" class="form-control" Required>
                            </div>
                            <button class="px-4 ml-3 mt-3 py-2 text-white rounded" id="submitButton" type="submit">Add </button>
                        </div>
                    </form>
                </div>
            </div>
